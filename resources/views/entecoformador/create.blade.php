            ...
            <div class="card p-4">
                ...
                <form action="{{ route('entecoformador.store') }}" method="POST">
                    ...
                    <div class="mb-3 position-relative">
                        <input type="text" class="form-control" name="tdoc" placeholder="Tipo De Documento" >
                    ...
                    <div class="mb-3 position-relative">
                        <textarea class="form-control" name="razonsocial" rows="4" placeholder="Razón Social"></textarea>
                          @error('razonsocial')
                        <p class="text-danger">{{$message}}</p>
                         @enderror
                    ...
                    <button type="submit" class="btn btn-primary w-100 mb-2"><i class="fas fa-save me-2"></i>Registrar Entecoformador</button>
