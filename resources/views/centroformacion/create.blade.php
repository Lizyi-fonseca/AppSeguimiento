...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card p-4">
                <h3 class="card-title mb-4 text-center text-primary"><i class="fas fa-book-reader me-2"></i>Registro de Centros de Formación</h3>

                <!-- Formulario -->
                <form action="{{ route('centroformacion.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-3 position-relative">
                     ...
                     <div class="mb-3 position-relative">
                        <textarea class="form-control" name="tblregionales_nis" rows="4" placeholder="Nis De Regionales"></textarea>
                    ...
                    <button type="submit" class="btn btn-primary w-100 mb-2"><i class="fas fa-save me-2"></i>Registrar Centro</button>
