...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card p-4">
                <h3 class="card-title mb-4 text-center text-primary"><i class="fas fa-book-reader me-2"></i>Registrar Tipo De Documento</h3>
                ...
                <form action="{{ route('tipodocumento.store') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary w-100 mb-2"><i class="fas fa-save me-2"></i>Registrar Tipo De Documento</button>
