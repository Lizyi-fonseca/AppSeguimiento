        ...
        <div class="col-md-6">
            <div class="card p-4">
                ...
                <form action="{{ route('Regionales.store') }}" method="POST">
                    ...
                    <div class="mb-3 position-relative">
                        <textarea class="form-control" name="direccion" rows="4" placeholder="Direccion"></textarea>
                          @error('direccion')
                        <p class="text-danger">{{$message}}</p>
                         @enderror
                     ...
                     <div class="mb-3 position-relative">
                        <textarea class="form-control" name="observacion" rows="4" placeholder="Observacion"></textarea>
                          @error('observacion')
                        <p class="text-danger">{{$message}}</p>
                         @enderror
