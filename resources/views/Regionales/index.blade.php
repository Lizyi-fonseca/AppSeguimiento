...
<head>
    ...
    <style>
        body {
            background-color: #f4f8fc; /* mismo fondo suave */
        }
        ...
        .header-custom {
            background-color: #1b4965; /* azul claro formal */
            color: white;
        ...
        .table thead {
            background-color: #1b4965; /* mismo azul */
            color: white;
        }

        .table tbody tr:hover {
            background-color: #eef4fb; /* hover suave */
        }
                    ...
                    <tbody>
                        ...
                        @empty
                            ...
                            <div class="acciones justify-content-center">
                                ...
                                <form action="{{ route('Regionales.delete', $regional->nis) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
